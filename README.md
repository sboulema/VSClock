...
Request/inspiration for this extension came from this tweet:

> [@mkristensen](https://x.com/mkristensen) how about a simple extension that adds the system clock (with date/time options) to the status bar of VS 2026? I see one extension along this line but has chinese text in the description and don't trust it.
> 
